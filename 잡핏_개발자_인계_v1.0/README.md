...
> 📌 **버전 표기 정책 (2026-05-01 통일)**
>
> | 트랙 | 버전 | 의미 |
> |---|---|---|
> | **외부 인계 문서** (이 README · HANDOFF · CLAUDE · index.html) | **v1.0** | 인계 첫 정식판 — 모두 동일 버전 |
> | **서비스 기획안** ([잡핏_기획안_v1_4.md](잡핏_기획안_v1_4.md)) | **v1.4** | 비즈니스 정책 진화 트랙 (별도) |
> | **프로토타입 코드 내부** (v0.1 ~ v0.12) | v0.x | 코드 진화 이력 — [잡핏_변경이력.md](잡핏_변경이력.md)에 보존 |
>
> 이전에는 HANDOFF v0.7, CLAUDE v0.5, index.html v0.3 등 트랙이 섞였으나, 외부 인계는 **v1.0** 단일로 통일됨.
> 내부 코드 진화 이력(v0.x)은 변경이력 문서에서 추적 가능.
